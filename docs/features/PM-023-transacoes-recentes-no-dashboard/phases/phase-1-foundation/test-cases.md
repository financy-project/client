...
- [ ] T-001: `useGetDashboard` returns `recentTransactions` from `data.dashboard.recentTransactions`
- [ ] T-002: `useGetDashboard` returns `recentTransactions: []` before the query resolves
